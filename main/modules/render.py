...
class Render(Ressources):
    ...
    def __init__(self,width,height,screen):
        ...
        Ressources.fonts = [
            pygame.font.Font("main/assets/fonts/BebasNeue-Regular.ttf", width // 20),
            pygame.font.Font("main/assets/fonts/3X5_____.TTF", width // 20),
            pygame.font.Font("main/assets/fonts/BebasNeue-Regular.ttf", width // 30)
        ]
        self.Offsets = []
        self.gameChoices = []
        N = 6
