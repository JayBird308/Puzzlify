...
class LooseMenu:
    def __init__(self):
        ...
        self.logoOff = pygame.image.load('main/assets/Logo/Trizzle.png').convert_alpha()
        self.logoOn = pygame.image.load('main/assets/Logo/light.png').convert_alpha()
        self.sound = pygame.mixer.Sound("main/assets/sounds/logo.wav")
        self.soundNeon = pygame.mixer.Sound("main/assets/sounds/neon.wav")
        self.soundFailure = pygame.mixer.Sound("main/assets/sounds/failure2.wav")
        self.first = True
        self.screen = Ressources.screen
        ...
        retrayImgs = [
            pygame.image.load('main/assets/imgs/retry.png').convert_alpha(),
            pygame.image.load('main/assets/imgs/retrySel.png').convert_alpha()
        ]
        exitImgs = [
            pygame.image.load('main/assets/imgs/exit.png').convert_alpha(),
            pygame.image.load('main/assets/imgs/exitSel.png').convert_alpha()
        ]
