...
class Ressources:
    def __init__(self):
        ...
        Ressources.playedSound = pygame.mixer.Sound("main/assets/sounds/played.wav")
        Ressources.returnedSound = pygame.mixer.Sound("main/assets/sounds/returned.wav")
        Ressources.destroyedSound = pygame.mixer.Sound("main/assets/sounds/blows.wav")
        Ressources.numbers = [
            pygame.image.load('main/assets/imgs/numbers/0.png').convert_alpha(),
            pygame.image.load('main/assets/imgs/numbers/1.png').convert_alpha(),
            pygame.image.load('main/assets/imgs/numbers/2.png').convert_alpha(),
            pygame.image.load('main/assets/imgs/numbers/3.png').convert_alpha(),
            pygame.image.load('main/assets/imgs/numbers/4.png').convert_alpha(),
            pygame.image.load('main/assets/imgs/numbers/5.png').convert_alpha(),
            pygame.image.load('main/assets/imgs/numbers/6.png').convert_alpha(),
            pygame.image.load('main/assets/imgs/numbers/7.png').convert_alpha(),
            pygame.image.load('main/assets/imgs/numbers/8.png').convert_alpha(),
            pygame.image.load('main/assets/imgs/numbers/9.png').convert_alpha()
        ]
        self.getColoredUpAndDowns()
    
    def getColoredUpAndDowns(self):
        greyUp = pygame.image.load('main/assets/up.png').convert_alpha()
        greyDown = pygame.image.load('main/assets/down.png').convert_alpha()
        ...
        greenUp = pygame.image.load('main/assets/up/green.png').convert_alpha()
        greenDown = pygame.image.load('main/assets/down/green.png').convert_alpha()
        yellowUp = pygame.image.load('main/assets/up/yellow.png').convert_alpha()
        yellowDown = pygame.image.load('main/assets/down/yellow.png').convert_alpha()
        orangeUp = pygame.image.load('main/assets/up/orange.png').convert_alpha()
        orangeDown = pygame.image.load('main/assets/down/orange.png').convert_alpha()
        cyonUp = pygame.image.load('main/assets/up/cyon.png').convert_alpha()
        cyonDown = pygame.image.load('main/assets/down/cyon.png').convert_alpha()
    ...
    def readConfigFile():
        try:
            doc = xml.dom.minidom.parse("main/assets/config.xml")
            Ressources.doc = doc
    ...
    def del_save():
        ...
        for anySave in oldSaves:
            SavesParent.removeChild(anySave)
        with open("main/assets/config.xml", "w") as xml_file:
            Ressources.doc.writexml(xml_file)
    @staticmethod 
    def getScores():
